...
plt.plot(taulist, Popu_halfpiRead, label=f"pi/2 read")
plt.plot(taulist, Popu_3halfpiRead, label=f"3pi/2 read")
plt.plot(taulist, Popu_Substract, label=f"Substract")
plt.xlabel('Tau')
...
plt.figure(figsize=(8, 5))
plt.plot(taulist, np.multiply(Decay_coeff,Popu_Substract), label=f"Substract with 10u T2 Decay")
plt.xlabel('Tau')
plt.ylabel('Population in 0')
plt.legend()
plt.title('T2 Curve')
...
Decay_coeff = np.exp(- Decay_Rate * taulist)
plt.figure(figsize=(8, 5))
plt.plot(taulist, np.multiply(Decay_coeff,Popu_Substract), label=f"Substract with 20u T2(8) Decay")
plt.xlabel('Tau')
plt.ylabel('Population in 0')
plt.legend()
plt.title('XY8 Curve')
